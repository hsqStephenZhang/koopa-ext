//! copied from https://github.com/pku-minic/koopa/blob/68461c154629812e221052705c53c6cad240e75a/koopa/examples/opt/dce.rs
...
impl DeadCodeElimination {
    pub fn new() -> Self {
        Self { worklist: Vec::new(), liveset: HashSet::new() }
    }
